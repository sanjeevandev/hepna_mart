        ...
        <div className="container-custom">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <button className="hidden lg:flex items-center gap-1.5 p-2 text-white hover:text-accent transition-colors text-sm font-medium">
              ...
              <Link to="/wishlist" className="relative p-2 text-white hover:text-accent transition-colors">
              ...
              <Link to="/cart" className="relative p-2 text-white hover:text-accent transition-colors flex items-center gap-2">
