...
import { Heart, ShoppingCart, Zap, Truck, CheckSquare, Square, FolderPlus } from 'lucide-react';
      ...
      <div className="card h-full flex flex-col group relative overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-sm transition-all duration-300 ease-out hover:-translate-y-[3px] hover:shadow-card-hover">
        ...
        >
          ...
          <div className="p-4 sm:p-5 flex flex-col flex-grow">
            ...
            {/* Pricing */}
            <div className="mt-auto mb-2 pt-1">
              <PriceDisplay 
                price={product.price} 
                mrp={product.mrp} 
            ...
            {/* Utility Bar: Compare & Add to Project */}
            <div className="flex items-center justify-between mb-3 text-xs">
              <div 
                className="flex items-center gap-1.5 cursor-pointer select-none text-gray-600 hover:text-primary transition-colors"
              ...
              >
                ...
                <span className={compared ? 'text-accent font-semibold text-[11px]' : 'text-[11px]'}>
